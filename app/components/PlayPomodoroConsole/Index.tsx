...
export const PlayPomodoroConsole: React.FC<Props> = (props: Props) => {
  ...
  const getSpotifyPlaylist = (
    ...
    const playlist = spotifyPlaylistItems.find(
  ...
  useEffect(() => {
    ...
    const handleGetPomodoro = async () => {
      ...
      const work_time_playlist = getSpotifyPlaylist(
        pomodoro.work_time_playlist_id,
        spoitifyPlaylists
      )
      const break_time_playlist = getSpotifyPlaylist(
  ...
  return (
    <div className="flex-row items-center justify-center">
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-col">
          <div>
            ...
            >
              <image
                xlinkHref={pomodoro.work_time_playlist_image!}
                x="0"
                y="0"
                height="100%"
                width="100%"
          ...
          <div>
            ...
            <div className="mt-4 text-2xl">
              集中時間： {pomodoro.work_time / 60 / 1000} 分
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          <div>
            ...
            >
              <image
                xlinkHref={pomodoro.break_time_playlist_image!}
                x="0"
                y="0"
                height="100%"
                width="100%"
          ...
          <div>
            ...
            <div className="mt-4 text-2xl">
              休憩時間： {pomodoro.break_time / 60 / 1000} 分
            </div>
          </div>
        </div>
      </div>
      <div className="w-full ">
        ...
        <div className="my-4 text-2xl">セット数： {pomodoro.term_count}</div>
        <hr className="h-px my-4 bg-gray-200 border-0 dark:bg-gray-700" />
